import { MediaBunnyVideoToImageList }
    from '@shared/service/video-to-img-list/media-bunny.js';

import { CVValData } from '../data/cvval-data.js';
import type { IDetector } from './detector.js';
