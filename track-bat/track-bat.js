...
import { TrackBatData } from "../src/cv-val/track-bat/track-bat-data.js"
import * as BatDetector from '../src/cv-val/track-bat/bat-detector/index.js';
...
processButton.addEventListener('click', async () => {
    ...
    try {
        ...
        const ret = await processor.processVideo(fileInput.files, new TrackBatData());
