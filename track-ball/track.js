...
import { TrackBallData } from "../src/cv-val/track-ball/track-ball-data.js"
import * as BallDetector from '../src/cv-val/track-ball/ball-detector/index.js';
...
processButton.addEventListener('click', async () => {
    ...
    try {
        ...
        const ret = await processor.processVideo(fileInput.files, new TrackBallData());
